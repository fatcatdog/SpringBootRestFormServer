...
public class FormDataRepo {
	...
	public boolean updateForm(FormData formData) {
		...
		try {
			jdbcTemplate.update(sql, formData.getAnswerQuestion1(), formData.getAnswerQuestion2(), formData.getAnswerQuestion3(), formData.getAnswerQuestion4(), formData.getId());
			return true; 
		} catch (Exception e) {
